...
<div class="rounded mb-3 hero2">
  <div class="row align-items-center justify-content-between">
    <div class="col-xs-8 col-md-8">
      ...
      <p>Tu negocio también puede estár publicado aquí y es totalmente SIN COSTO. <br /><a href="{{site.baseurl}}/anunciate" class="btn btn-dark text-white px-5 btn-lg">Anúnciate</a> con nosotros. <br />Recuerda: <strong>#ConsumeLocal</strong></p>
    </div>
